...
class TableManager {
    constructor() {
        ...
        this.currentPage = 1;
        this.recordsPerPage = 10; // Default value
    ...
    getTotalPages() {
        const rows = document.querySelectorAll('tbody tr');
        return Math.ceil(rows.length / this.recordsPerPage);
    }
    ...
    updatePagination() {
        ...
        if (paginationInfo) {
            paginationInfo.textContent = `Showing ${startRecord}-${endRecord} of ${totalRows} alumni`;
        }
